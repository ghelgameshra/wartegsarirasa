...
@section('container')
    <h1 class="text-dark text-center">{{ $title }}</h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="position-absolute text-white px-3 py-1 w-100 text-center" style="background-color: rgb(25,135,84, 0.8)">
                        <a href="/posts?category={{ $post->category->slug }}" class="text-decoration-none text-white" style="background-color: inherit;background: transparent;">{{ $post->category->name }}</a>
                    </div>
